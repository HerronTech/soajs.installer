...
var dashboards = [
	...
	{
		"_id": "Metricbeat-Docker-container",
		"_type": "dashboard",
		"_shipper": "metricbeat",
		"_source": {
			"env": "%env%",
			...
			"timeRestore": false,
			"kibanaSavedObjectMeta": {
				"searchSourceJSON": "{\"filter\":[{\"query\":{\"query_string\":{\"analyze_wildcard\":true,\"query\":\"docker.container.name:dashboard-filebeat.1.kijip1mevm6ca8geistqcmwnr\"}}}]}"
			}
		}
	},
	{
		"_id": "Metricbeat-Docker-service",
		"_type": "dashboard",
		"_shipper": "metricbeat",
		"_source": {
			"env": "%env%",
